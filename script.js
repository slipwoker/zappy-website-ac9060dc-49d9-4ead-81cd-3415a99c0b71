    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שרון גל עיצוב שיער משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'ac9060dc-49d9-4ead-81cd-3415a99c0b71',
                    name: data.name || '',
                    email: data.email || '',
